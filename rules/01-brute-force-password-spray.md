...
// Threshold: 10+ failures — tune based on your environment
// Lower to 5 for stricter detection, raise to 20+ in high-traffic orgs
...
## Tuning Tips
- Default threshold is 10 — lower to 5 for stricter detection, raise to 20+ in high-traffic environments
...
During hands-on testing in the Log(N) Pacific cyber range (April 1, 2026), rule 01 surfaced account `cdeb4c73...@lognpacific.com` with 23 failed attempts across 3 IPs over a 45-minute window.
...
**Escalation:** Would escalate to Tier 2 for account lockout and credential reset. Password change (50133) suggests account may have been previously compromised.
